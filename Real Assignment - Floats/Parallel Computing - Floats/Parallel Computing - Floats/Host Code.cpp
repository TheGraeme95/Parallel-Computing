...
//////////////////// Reading the data from the file //////////////////
	...
	ifstream inFileStream("temp_lincolnshire.txt");	
//////////////////// OPEN FILE ////////////////////////
...
///////////////////////////////////////////////////////////////////
	...
	try {
		...
		if (padding) // Padding the input vector with 0's to ensure that it is a multiple of 2.
		{			
		...
		vector<mytype> sorted = BitonicSort(context, queue, program, inputData);
		float median = sorted.at(0);
